...
const SYNC = .1
timeline
   .from('#Path_6',{ x:662,y:187.4,rotation:1080,ease:'ease-out'}) //translate(128.5 476.044)
   .from('#Path_5',{ x:0,y:40.381,rotation:1080,ease:'ease-out'},SYNC) //translate(265.32 337.484)
   .from('#Path_3',{ x:600,y:332.71,rotation:1080},SYNC) //translate(265.32 612.994)
